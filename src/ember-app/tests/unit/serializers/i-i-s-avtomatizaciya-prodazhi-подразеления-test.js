...
moduleForModel('i-i-s-avtomatizaciya-prodazhi-подразеления', 'Unit | Serializer | i-i-s-avtomatizaciya-prodazhi-подразеления', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-avtomatizaciya-prodazhi-подразеления',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
