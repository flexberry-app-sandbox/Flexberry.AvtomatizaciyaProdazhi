...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi номенклатуры l');

test('testing i-i-s-avtomatizaciya-prodazhi-номенклатуры-l', function(assert) {
