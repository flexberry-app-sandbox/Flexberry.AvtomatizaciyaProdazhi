...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi контрагенты l');

test('testing i-i-s-avtomatizaciya-prodazhi-контрагенты-l', function(assert) {
