...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi отчет о продажах l');

test('testing i-i-s-avtomatizaciya-prodazhi-отчет-о-продажах-l', function(assert) {
