...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi подразеления l');

test('testing i-i-s-avtomatizaciya-prodazhi-подразеления-l', function(assert) {
