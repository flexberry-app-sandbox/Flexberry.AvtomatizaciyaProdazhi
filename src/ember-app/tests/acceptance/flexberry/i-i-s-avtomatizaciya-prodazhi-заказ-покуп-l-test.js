...
moduleForAcceptance('[AGAT] Acceptance | i i s avtomatizaciya prodazhi заказ покуп l');

test('testing i-i-s-avtomatizaciya-prodazhi-заказ-покуп-l', function(assert) {
