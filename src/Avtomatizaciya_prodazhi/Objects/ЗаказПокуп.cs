...
namespace IIS.Avtomatizaciya_prodazhi
{
    ...
    [View("ЗаказПокупL", new string[] {
            ...
            "Контрагенты.Контрагент as \'Контрагент\'",
            "Организации.Организация as \'Организация\'"})]
    public class ЗаказПокуп : IIS.Avtomatizaciya_prodazhi.ОтчетОПродажах
    {
        ...
        public override IIS.Avtomatizaciya_prodazhi.СостОплаты СостОплат
        {
            get
            {
                ...
                IIS.Avtomatizaciya_prodazhi.СостОплаты result = base.СостОплат;
        ...
        public override IIS.Avtomatizaciya_prodazhi.СостОгрузки СостОтгруз
        {
            get
            {
                ...
                IIS.Avtomatizaciya_prodazhi.СостОгрузки result = base.СостОтгруз;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупE", typeof(IIS.Avtomatizaciya_prodazhi.ЗаказПокуп));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЗаказПокупL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЗаказПокупL", typeof(IIS.Avtomatizaciya_prodazhi.ЗаказПокуп));
                }
            }
        }
    }
