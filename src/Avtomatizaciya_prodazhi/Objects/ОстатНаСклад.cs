    ...
    public class ОстатНаСклад : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ОстатНаСкладE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОстатНаСкладE", typeof(IIS.Avtomatizaciya_prodazhi.ОстатНаСклад));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ОстатНаСкладL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ОстатНаСкладL", typeof(IIS.Avtomatizaciya_prodazhi.ОстатНаСклад));
                }
            }
        }
    }
