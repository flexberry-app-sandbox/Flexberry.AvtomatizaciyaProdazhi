    ...
    public class ЕдИзмер : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ЕдИзмерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдИзмерE", typeof(IIS.Avtomatizaciya_prodazhi.ЕдИзмер));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ЕдИзмерL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ЕдИзмерL", typeof(IIS.Avtomatizaciya_prodazhi.ЕдИзмер));
                }
            }
        }
    }
